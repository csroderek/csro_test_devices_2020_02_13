...
from csro_rgblight import CSRO_RGBlight
from csro_switch import CSRO_Switch
from csro_motor import CSRO_Motor
from csro_airsys import CSRO_AirSystem

if __name__ == "__main__":
    CSRO_Switch("ca34bb4e4767", "switch_csro_1k1r", 1).start()
    CSRO_Switch("286af026505e", "switch_csro_1k1r", 1).start()
    CSRO_Switch("da34bb4e5767", "switch_csro_1k1r", 1).start()
    CSRO_Switch("186aa026604e", "switch_csro_1k1r", 1).start()
    ...
    CSRO_RGBlight("55ad0904a51a", "rgblight_csro_3k3scr").start()
    CSRO_RGBlight("56aa0904a614", "rgblight_csro_3k3scr").start()
    CSRO_RGBlight("57af0904a715", "rgblight_csro_3k3scr").start()
    CSRO_RGBlight("58ae0904a914", "rgblight_csro_3k3scr").start()
